...
function cmdCatBashrc() {
  println('<span class="purple">export</span> <span class="cmd">VERSION</span>=<span class="amber">' + VERSION + '</span>');
}
...
function cmdCatVimrc() {
  const lines = [
    ...
    '<span class="purple">nnoremap</span> <span class="cmd">&lt;leader&gt;q</span> <span class="blue">:qa!&lt;CR&gt;</span>',
  ];
